...
cpd/
  ...
  crates/
    ...
    cpd-eval/             # optional: metrics + synthetic datasets + baselines
  python/
...
- cpd-eval (optional)
- synthetic datasets + evaluation metrics + baseline comparisons (for doctor + docs)
...
- detect_offline(x, detector=..., cost=..., constraints=..., stopping=..., return_diagnostics=True)
...
- Return dataclass-like objects:
  ...
  - OnlineStepResult: .t, .p_change, .run_length_mode, .run_length_mean (online)
...
- Core abstractions (cpd-core)
  ...
  - Constraints, Penalty, Stopping, cancellation/progress wiring, time/compute budgets
...
- Evaluation utilities (cpd-eval)
  - synthetic data generators + metrics (for docs + doctor validation)
- Quality & benchmarks
