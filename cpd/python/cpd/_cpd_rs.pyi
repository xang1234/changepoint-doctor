...
class Bocpd:
    ...
    def reset(self) -> None: ...
    def save_state(self) -> _BocpdState: ...
    def load_state(self, state: _BocpdState) -> None: ...
...
class Cusum:
    ...
    def update_many(self, x_batch: Any) -> list[OnlineStepResult]: ...
    def reset(self) -> None: ...
    def save_state(self) -> _CusumState: ...
    def load_state(self, state: _CusumState) -> None: ...
...
class PageHinkley:
    ...
    def update_many(self, x_batch: Any) -> list[OnlineStepResult]: ...
    def reset(self) -> None: ...
    def save_state(self) -> _PageHinkleyState: ...
    def load_state(self, state: _PageHinkleyState) -> None: ...
