...
fn bench_binseg_l2(c: &mut Criterion, case_id: &str, n: usize, jump: usize, penalty: f64) {
...
fn benchmark_binseg_l2_n1e4_d1_jump1(c: &mut Criterion) {
    const N: usize = 10_000;
    bench_binseg_l2(c, "binseg_l2_n1e4_d1_jump1", N, 1, 10.0);
}

fn benchmark_binseg_l2_n1e5_d1_jump1(c: &mut Criterion) {
    const N: usize = 100_000;
    bench_binseg_l2(c, "binseg_l2_n1e5_d1_jump1", N, 1, 10.0);
}

fn benchmark_binseg_l2_n1e6_d1_jump1(c: &mut Criterion) {
    const N: usize = 1_000_000;
    bench_binseg_l2(c, "binseg_l2_n1e6_d1_jump1", N, 1, 20.0);
}

criterion_group!(
    benches,
    benchmark_binseg_l2_n1e4_d1_jump1,
    benchmark_binseg_l2_n1e5_d1_jump1,
    benchmark_binseg_l2_n1e6_d1_jump1
);
